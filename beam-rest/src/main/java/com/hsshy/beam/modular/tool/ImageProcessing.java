        ...
        for (int x = 0; x < files.length; x++) {
            ...
            for (int i = minx; i < width; i++) {
                for (int j = miny; j < height; j++) {
                    ...
                    if ((rgb[0] < 110 && rgb[1]<100 && rgb[2] > 100) || (rgb[0] > 130 && rgb[1] < 40 && rgb[2] < 40)) {
                    ...
                    //修改像素点，0x007ABB是证件照的蓝色背景色
//                    if (rgb[0] < 110 && rgb[0] > 50 && rgb[1] < 30 && rgb[1] > 10 && rgb[2] < 50 && rgb[2] > 25) {
//                        bi.setRGB(i, j, 0x007ABB);
//                    }
                }
             ...
             * 将缓冲对象保存到新文件中
             */
            FileOutputStream ops = new FileOutputStream(new File("d:/tmp/img/new_" + files[x].getName()));
